    ...
    <div class = "top_menu">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active ">
                <a name="element" class="nav-link font-italic" href="/profil"> Profile <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active ">
                <a name="element" class="nav-link font-italic" href="/mainPage"> Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item active">
            ...
            <li class="nav-item active">
                <a name="element" class="nav-link font-italic" href="/workouts">Search <span
                            class="sr-only">(current)</span></a>
            </li>
<#--            //TODO(ссылки поменяй)-->
        </ul>
